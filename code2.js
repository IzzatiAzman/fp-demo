...
gdjs.Level2Code.GDplayernameObjects1= [];
gdjs.Level2Code.GDplayernameObjects2= [];
gdjs.Level2Code.GDplayernameObjects3= [];
gdjs.Level2Code.GDplayernameObjects4= [];
gdjs.Level2Code.GDLeaderboardObjects1= [];
gdjs.Level2Code.GDLeaderboardObjects2= [];
gdjs.Level2Code.GDLeaderboardObjects3= [];
gdjs.Level2Code.GDLeaderboardObjects4= [];
gdjs.Level2Code.GDtxtEntryObjects1= [];
gdjs.Level2Code.GDtxtEntryObjects2= [];
gdjs.Level2Code.GDtxtEntryObjects3= [];
gdjs.Level2Code.GDtxtEntryObjects4= [];
...
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17742964);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17711380);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17704444);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17739844);
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
{
gdjs.copyArray(runtimeScene.getObjects("Timer"), gdjs.Level2Code.GDTimerObjects3);
{for(var i = 0, len = gdjs.Level2Code.GDTimerObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDTimerObjects3[i].getBehavior("Text").setText(gdjs.evtTools.common.toString(Math.round(Math.abs(gdjs.evtTools.runtimeScene.getTimerElapsedTimeInSeconds(runtimeScene, "Level")))));
}
}}
...
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDCoinObjects3Objects = Hashtable.newFrom({"Coin": gdjs.Level2Code.GDCoinObjects3});
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDCoinParticlesObjects3Objects = Hashtable.newFrom({"CoinParticles": gdjs.Level2Code.GDCoinParticlesObjects3});
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects2Objects = Hashtable.newFrom({"Player": gdjs.Level2Code.GDPlayerObjects2});
...
gdjs.copyArray(runtimeScene.getObjects("Coin"), gdjs.Level2Code.GDCoinObjects3);
gdjs.copyArray(runtimeScene.getObjects("Player"), gdjs.Level2Code.GDPlayerObjects3);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects3Objects, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDCoinObjects3Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
/* Reuse gdjs.Level2Code.GDCoinObjects3 */
gdjs.Level2Code.GDCoinParticlesObjects3.length = 0;

{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDCoinParticlesObjects3Objects, (( gdjs.Level2Code.GDCoinObjects3.length === 0 ) ? 0 :gdjs.Level2Code.GDCoinObjects3[0].getCenterXInScene()), (( gdjs.Level2Code.GDCoinObjects3.length === 0 ) ? 0 :gdjs.Level2Code.GDCoinObjects3[0].getCenterYInScene()), "");
}{for(var i = 0, len = gdjs.Level2Code.GDCoinObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDCoinObjects3[i].deleteFromScene(runtimeScene);
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects2Objects, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDEggObjects2Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
...
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDCoinParticlesObjects2Objects, (( gdjs.Level2Code.GDCoinObjects2.length === 0 ) ? 0 :gdjs.Level2Code.GDCoinObjects2[0].getCenterXInScene()), (( gdjs.Level2Code.GDCoinObjects2.length === 0 ) ? 0 :gdjs.Level2Code.GDCoinObjects2[0].getCenterYInScene()), "");
    ...
    gdjs.Level2Code.GDEggObjects2[i].deleteFromScene(runtimeScene);
}
}{runtimeScene.getScene().getVariables().getFromIndex(0).add(100);
}{gdjs.evtTools.sound.playSound(runtimeScene, "coin.mp3", false, 50, 1);
}}
...
{for(var i = 0, len = gdjs.Level2Code.GDEndScreenSubHeaderObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDEndScreenSubHeaderObjects3[i].getBehavior("Text").setText("You got " + gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().getFromIndex(0)) + " points!");
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17782364);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Level2Code.GDRetryButtonObjects2.length;i<l;++i) {
    if ( gdjs.Level2Code.GDRetryButtonObjects2[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.Level2Code.GDRetryButtonObjects2[k] = gdjs.Level2Code.GDRetryButtonObjects2[i];
        ++k;
    }
}
gdjs.Level2Code.GDRetryButtonObjects2.length = k;
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("Leaderboard"), gdjs.Level2Code.GDLeaderboardObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Level2Code.GDLeaderboardObjects1.length;i<l;++i) {
    if ( gdjs.Level2Code.GDLeaderboardObjects1[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.Level2Code.GDLeaderboardObjects1[k] = gdjs.Level2Code.GDLeaderboardObjects1[i];
        ++k;
    }
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17779532);
}
}
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("txtEntry"), gdjs.Level2Code.GDtxtEntryObjects2);
...
}{runtimeScene.getScene().getVariables().get("User").getChild("name").setString((( gdjs.Level2Code.GDtxtEntryObjects2.length === 0 ) ? "" :gdjs.Level2Code.GDtxtEntryObjects2[0].getText()));
...
gdjs.Level2Code.GDplayernameObjects1.length = 0;
gdjs.Level2Code.GDplayernameObjects2.length = 0;
gdjs.Level2Code.GDplayernameObjects3.length = 0;
gdjs.Level2Code.GDplayernameObjects4.length = 0;
gdjs.Level2Code.GDLeaderboardObjects1.length = 0;
gdjs.Level2Code.GDLeaderboardObjects2.length = 0;
gdjs.Level2Code.GDLeaderboardObjects3.length = 0;
gdjs.Level2Code.GDLeaderboardObjects4.length = 0;
gdjs.Level2Code.GDtxtEntryObjects1.length = 0;
gdjs.Level2Code.GDtxtEntryObjects2.length = 0;
gdjs.Level2Code.GDtxtEntryObjects3.length = 0;
gdjs.Level2Code.GDtxtEntryObjects4.length = 0;
